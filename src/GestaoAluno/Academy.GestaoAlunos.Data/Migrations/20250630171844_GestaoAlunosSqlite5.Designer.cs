...
namespace Academy.GestaoAlunos.Data.Migrations
{
    ...
    [Migration("20250630171844_GestaoAlunosSqlite5")]
    partial class GestaoAlunosSqlite5
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Academy.GestaoAlunos.Domain.Entities.Certificado", b =>
                {
                    ...
                    b.HasOne("Academy.GestaoAlunos.Domain.Entities.Matricula", null)
                        .WithOne("certificado")
                        .HasForeignKey("Academy.GestaoAlunos.Domain.Entities.Certificado", "MatriculaId1");
